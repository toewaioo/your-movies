...
function MoviesPage({ movies }) {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gradient-to-br from-indigo-50 to-white pb-16", children: [
    ...
    /* @__PURE__ */ jsx("header", { className: "bg-white shadow sticky top-0 z-10", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 py-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-2xl md:text-3xl font-extrabold text-indigo-700", children: "Movies" }),
    ...
    /* @__PURE__ */ jsxs("main", { className: "container mx-auto px-4 pt-8", children: [
      /* @__PURE__ */ jsx("div", { className: "grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-2 gap-6 mb-8", children: movies.data.length === 0 ? /* @__PURE__ */ jsx("div", { className: "col-span-full text-center text-gray-500", children: "No movies found." }) : movies.data.map((item) => /* @__PURE__ */ jsxs(
        Link,
        {
          href: `/movies/${item.id}`,
      ...
      /* @__PURE__ */ jsx("div", { className: "flex justify-center gap-2", children: movies.links.map((link, idx) => /* @__PURE__ */ jsx(
        Link,
        {
          href: link.url || "#",
